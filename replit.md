...
- August 11, 2025. MIRA - ASSISTENTE VIRTUALE AI IMPLEMENTATO: creato chatbot intelligente "Mira" con GPT-4o integration. Widget flottante nell'angolo del sito con design arancione/purple. Knowledge base completa su tutti i servizi WebPro Italia (pacchetti, prezzi, processi). Interfaccia chat professionale con messaggi timestamp, tono formale "lei", risposte contestuali. Mira conosce Lite €197, Standard €397, Premium €697, servizi aggiuntivi AutoBlog AI, tempistiche e garanzie. Assistente sempre disponibile per lead generation e supporto clienti.
- August 11, 2025. BACKEND ADMIN UNIFICATO COMPLETAMENTE: eliminati tab duplicati "Scheduler" e "SEO-Strategy" dall'admin. Tutte le impostazioni ora unificate in un unico tab "Impostazioni" con sezioni ordinate: Tracciamento/Analytics, Sistema Blog Automatico (con toggle funzionante), Pagamenti. Admin ora pulito con solo tab essenziali: Lead, Blog, Galleria, Ticket, Impostazioni.
- July 30, 2025. SEZIONE "I NOSTRI LAVORI" RIMOSSA DA ADMIN: eliminata completamente la sezione "I Nostri Lavori" dal backend amministrativo come richiesto dall'utente. Admin panel ora pulito con solo sezioni essenziali: Lead, Blog, Scheduler, SEO, Galleria, Ticket, Impostazioni.
